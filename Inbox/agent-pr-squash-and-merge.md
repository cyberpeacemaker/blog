...
Save this script as something generic, like `.github/scripts/finish-ai-task.sh`.
...
>         
> 3. **Wrap Up:** When all phases are fully completed, run the automation script to clean up: `bash .github/scripts/finish-ai-task.sh`
>     
