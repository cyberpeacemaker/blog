...
- input 
	- user prompt
	- existed context / conversation
- output 
	- token
- efforts  / pricing difference of [input, output]
...
## [Understanding tokens](https://cursor.com/learn/tokens-pricing#understanding-tokens)
...
## [Streaming responses](https://cursor.com/learn/tokens-pricing#streaming-responses)
...
## [Optimizing token usage](https://cursor.com/learn/tokens-pricing#optimizing-token-usage)
