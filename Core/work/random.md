...
周末的工作讓我發現，果然平日上班環境太差，根本無法執行高質量的工作
昨晚進行到BEC，我確定了一個項目，他的解釋是說不通的，不是我漏看，所以我準備來看到底為什麼
太痛苦了，也許在這裡，適合看中文，那這樣角度出發，BEC可能是個選擇？
但其實BEC我現在已經開始到需要高度專注的地步了，我想先來定義一下我BEC的狀態
