# AI murmur
- 就喜歡AI ((讓我想到，以前人會說喜歡手工品，因為機器的沒有溫度，可是實際是根本分不出來哪些是手工，哪些是機器做的。問比較喜歡哪個，往往是選機器做的便宜又精緻)
- 什麼是AI味 (哪有AI味，資料餵什麼模型怎麼訓練，牠就乖乖產出成果。讓我想到以前人說AI畫圖超明顯，一眼就看出來，但現在根本就分不出來)
- 空白排版美學 ("是精緻的「四分之一字寬（Thin Space）」，看起來若即若離，非常優雅。 **AI 吐出的空格：** 是粗暴的「半形空格（Space）」"原來有這回事，完全不知道)
# 搬遷
- todo
